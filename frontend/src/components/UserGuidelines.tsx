        ...
        <CardContent>
          <ol className="list-decimal ml-6 space-y-2 text-gray-700">
            <li>
              ...
              the items you need, and add them to your booking.
            </li>
            <li>
              <strong>Payment Process:</strong> Lorem ipsum dolor sit amet
              consectetur adipisicing elit. Iure blanditiis obcaecati quaerat in
              id doloremque explicabo sit eos sed fuga libero natus similique
              itaque, incidunt, odio nemo modi. Eum, voluptatibus.
            </li>
            <li>
