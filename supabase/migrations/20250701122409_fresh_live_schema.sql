...
CREATE OR REPLACE FUNCTION "public"."calculate_daily_analytics"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."calculate_daily_analytics"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."calculate_test_metrics"("item_id" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
    result jsonb;
...
ALTER FUNCTION "public"."calculate_test_metrics"("item_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_user_highest_tenant_role"("p_user_id" "uuid", "p_tenant_id" "uuid") RETURNS "public"."tenant_role"
...
ALTER FUNCTION "public"."get_user_highest_tenant_role"("p_user_id" "uuid", "p_tenant_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_user_tenant_roles"("p_user_id" "uuid", "p_tenant_id" "uuid") RETURNS TABLE("role_name" "public"."tenant_role", "granted_at" timestamp with time zone)
    LANGUAGE "sql" SECURITY DEFINER
    AS $$
...
ALTER FUNCTION "public"."get_user_tenant_roles"("p_user_id" "uuid", "p_tenant_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."has_tenant_admin_role"("p_tenant_id" "uuid") RETURNS boolean
...
ALTER FUNCTION "public"."has_tenant_admin_role"("p_tenant_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."user_has_tenant_role"("p_user_id" "uuid", "p_tenant_id" "uuid", "p_role" "public"."tenant_role") RETURNS boolean
    LANGUAGE "sql" SECURITY DEFINER
    AS $$
    SELECT EXISTS (
        SELECT 1 
...
ALTER FUNCTION "public"."user_has_tenant_role"("p_user_id" "uuid", "p_tenant_id" "uuid", "p_role" "public"."tenant_role") OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."calculate_daily_analytics"() TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_daily_analytics"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_daily_analytics"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."calculate_test_metrics"("item_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_test_metrics"("item_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_test_metrics"("item_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_user_highest_tenant_role"("p_user_id" "uuid", "p_tenant_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_user_highest_tenant_role"("p_user_id" "uuid", "p_tenant_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_user_highest_tenant_role"("p_user_id" "uuid", "p_tenant_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_user_tenant_roles"("p_user_id" "uuid", "p_tenant_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_user_tenant_roles"("p_user_id" "uuid", "p_tenant_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_user_tenant_roles"("p_user_id" "uuid", "p_tenant_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."has_tenant_admin_role"("p_tenant_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."has_tenant_admin_role"("p_tenant_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."has_tenant_admin_role"("p_tenant_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."user_has_tenant_role"("p_user_id" "uuid", "p_tenant_id" "uuid", "p_role" "public"."tenant_role") TO "anon";
GRANT ALL ON FUNCTION "public"."user_has_tenant_role"("p_user_id" "uuid", "p_tenant_id" "uuid", "p_role" "public"."tenant_role") TO "authenticated";
GRANT ALL ON FUNCTION "public"."user_has_tenant_role"("p_user_id" "uuid", "p_tenant_id" "uuid", "p_role" "public"."tenant_role") TO "service_role";
