...
//        * Debugging
//        */
//       if (!quantity) throw new Error("Missing item quantity");
//       if (!item_id) throw new Error("Missing item ID");
//       if (!start_date) throw new Error("Missing item start_date");
//       if (!end_date) throw new Error("Missing item start_date");
