...
CREATE TABLE IF NOT EXISTS "public"."booking_items" (
    ...
    CONSTRAINT "order_items_status_check" CHECK (("status" = ANY (ARRAY['pending'::"public"."booking_status", 'confirmed'::"public"."booking_status", 'cancelled'::"public"."booking_status", 'rejected'::"public"."booking_status"])))
);
...
CREATE OR REPLACE VIEW "public"."view_bookings_with_details" AS
 SELECT "b"."id",
   ...
   FROM ((("public"."bookings" "b"
     ...
     LEFT JOIN "public"."organizations" "org" ON (("bi"."provider_organization_id" = "org"."id")))
  GROUP BY "b"."id", "b"."booking_number", "b"."user_id", "b"."status", "b"."notes", "b"."created_at", "b"."updated_at"
  ORDER BY "b"."created_at" DESC;


ALTER TABLE "public"."view_bookings_with_details" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."view_manage_storage_items" AS
 SELECT (("s"."translations" -> 'fi'::"text") ->> 'item_name'::"text") AS "fi_item_name",
  ...
  GROUP BY "s"."id", "s"."translations", "s"."quantity", "s"."created_at", "s"."is_active", "s"."location_id", "l"."name", "s"."available_quantity", "s"."is_deleted", "s"."org_id";
