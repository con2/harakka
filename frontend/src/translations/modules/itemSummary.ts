export const itemSummary = {
  headings: {
    en: "New Items Summary",
    fi: "Yhteenveto uusista tuotteista",
  },
  buttons: {
    goToItemCreation: {
      en: "Go to item creation",
      fi: "Siirry tuotteen luontiin",
    },
    uploadItems: {
      en: "Upload items to organization",
      fi: "Lataa tuotteet organisaatioon",
    },
    uploading: {
      en: "Uploading...",
      fi: "Ladataan...",
