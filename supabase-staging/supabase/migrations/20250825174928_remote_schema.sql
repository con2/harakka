...
CREATE TABLE IF NOT EXISTS "public"."promotions" (
    ...
    CONSTRAINT "promotions_discount_type_check" CHECK ((("discount_type")::"text" = ANY (ARRAY[('percentage'::character varying)::"text", ('fixed_amount'::character varying)::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."storage_images" (
    ...
    "is_active" boolean DEFAULT true,
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "storage_images_image_type_check" CHECK ((("image_type")::"text" = ANY (ARRAY[('main'::character varying)::"text", ('thumbnail'::character varying)::"text", ('detail'::character varying)::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."storage_item_images" (
    ...
    CONSTRAINT "storage_item_images_image_type_check" CHECK ((("image_type")::"text" = ANY (ARRAY[('main'::character varying)::"text", ('thumbnail'::character varying)::"text", ('detail'::character varying)::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."storage_working_hours" (
    ...
    "is_active" boolean DEFAULT true,
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "storage_working_hours_day_check" CHECK ((("day")::"text" = ANY (ARRAY[('monday'::character varying)::"text", ('tuesday'::character varying)::"text", ('wednesday'::character varying)::"text", ('thursday'::character varying)::"text", ('friday'::character varying)::"text", ('saturday'::character varying)::"text", ('sunday'::character varying)::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."user_addresses" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "user_addresses_address_type_check" CHECK ((("address_type")::"text" = ANY (ARRAY[('billing'::character varying)::"text", ('shipping'::character varying)::"text", ('both'::character varying)::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."user_ban_history" (
    ...
    "notes" "text",
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "user_ban_history_action_check" CHECK ((("action")::"text" = ANY (ARRAY[('banned'::character varying)::"text", ('unbanned'::character varying)::"text"]))),
    CONSTRAINT "user_ban_history_ban_type_check" CHECK ((("ban_type")::"text" = ANY (ARRAY[('banForRole'::character varying)::"text", ('banForOrg'::character varying)::"text", ('banForApp'::character varying)::"text"])))
);
...
CREATE OR REPLACE VIEW "public"."view_bookings_with_details" AS
 SELECT "b"."id",
   ...
   FROM (("public"."bookings" "b"
     LEFT JOIN "public"."booking_items" "bi" ON (("b"."id" = "bi"."booking_id")))
     LEFT JOIN "public"."storage_items" "si" ON (("bi"."item_id" = "si"."id")))
  GROUP BY "b"."id", "b"."booking_number", "b"."user_id", "b"."status", "b"."notes", "b"."created_at", "b"."updated_at"
  ORDER BY "b"."created_at" DESC;


ALTER VIEW "public"."view_bookings_with_details" OWNER TO "postgres";
...
ALTER VIEW "public"."view_bookings_with_user_info" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."view_item_location_summary" AS
 SELECT "si"."id" AS "storage_item_id",
  ...
  WHERE ("si"."items_number_total" > (0)::numeric)
  ORDER BY (("si"."translations" -> 'en'::"text") ->> 'item_name'::"text"), "sl"."name";


ALTER VIEW "public"."view_item_location_summary" OWNER TO "postgres";
...
ALTER VIEW "public"."view_item_ownership_summary" OWNER TO "postgres";
...
ALTER VIEW "public"."view_manage_storage_items" OWNER TO "postgres";
...
ALTER VIEW "public"."view_user_ban_status" OWNER TO "postgres";
...
ALTER VIEW "public"."view_user_roles_with_details" OWNER TO "postgres";
...
GRANT ALL ON TABLE "public"."view_bookings_with_details" TO "anon";
GRANT ALL ON TABLE "public"."view_bookings_with_details" TO "authenticated";
GRANT ALL ON TABLE "public"."view_bookings_with_details" TO "service_role";
